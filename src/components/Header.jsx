...
export default function Header() {
	...
	return (
		<header className="relative w-full sticky top-0 z-50 bg-gradient-to-r from-white/70 via-white/60 to-white/50 backdrop-blur-xl border-b border-gray-200 shadow-sm">
			...
			<AnimatePresence>
				{open && (
					<motion.div
						...
						className="absolute left-0 right-0 top-full md:hidden border-t border-gray-200 bg-white/95 backdrop-blur-xl shadow-md z-40"
					>
